...
# msms sims 
cmdl0='../bin/msms -N %s  -ms 1064 1 -seed %s   -t 120  -r 160 250000    -I 2 492  572 0  -n 1 42.4  -n 2 51.2 -g 2 783.99 -g 1 664.0  -m 1 2 0.31  -m 2 1 0.31 -eg 0.005115 1 0 -eg 0.005115  2 10.24 -em 0.005115  1 2 0.31  -em 0.005115 2 1 0.31  -en 0.023 2 0.186100  -em 0.023000 1 2 6  -em 0.023000 2 1   6 -ej 0.051 2 1  -en 0.148 1 0.73100  -SI %s  2  %s  %s  -Smark -Sp 0.5 -Sc 0 2 %s %s  %s > %s/myout.%s.%s.%s.%s.%s.out' % (Ne ,myseed , time, f, f, wAA, wAa, waa, tmp_dir, f*100,s*100,h*100,t/1000,r )
os.system(cmdl0) 

#THIS IS A TEST COMMAND LINE i
#cmdl0='../bin/msms -N %s  -ms 1064 1 -seed %s  -t 1.2  -r 1.6 25000    -I 2 492  572 0  -n 1 42.4  -n 2 51.2 -g 2 783.99 -g 1 664.0  -m 1 2 0.31  -m 2 1 0.31 -eg 0.005115 1 0 -eg 0.005115  2 10.24 -em 0.005115  1 2 0.31  -em 0.005115 2 1 0.31  -en 0.023 2 0.186100  -em 0.023000 1 2 6  -em 0.023000 2 1   6 -ej 0.051 2 1  -en 0.148 1 0.73100  -SI %s  2  %s  %s  -Smark -Sp 0.5 -Sc 0 2 %s %s  %s > %s/myout.%s.%s.%s.%s.%s.out' % (Ne ,myseed , time, f, f, wAA, wAa, waa, tmp_dir, f*100,s*100,h*100,t/1000,r )
#os.system(cmdl0)
...
cpsummary='cp  %s/myout.%s.%s.%s.%s.%s.out.summary   /lustre/scratch113/teams/tyler-smith/users/cv1/scripts/hd_snpindels/REVISION/msms/msms/sims_ten' % (myuniqname)
os.system(cpsummary) 

#cpline='cp -r %s  /lustre/scratch113/teams/tyler-smith/users/cv1/scripts/hd_snpindels/REVISION/msms/msms/sims_ten' % (tmp_dir) 
#os.system(cpline) 
